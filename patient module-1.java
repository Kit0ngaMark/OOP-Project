...
public class PatientRec extends javax.swing.JFrame {
    ...
    public PatientRec() {
        initComponents();
        con = Connect.ConnectDB(); // Establish the database connection
        Get_Data();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(PatientRec.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
